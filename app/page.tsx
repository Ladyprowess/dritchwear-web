...
export default function HomePage() {
  ...
  /** ✅ FIX: Fire Google Ads conversion when someone actually clicks Google Play */
  ...
  return (
    <div>
      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-16 pb-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        {/* RIGHT - ✅ FIX: Using Next.js Image for faster load on mobile */}
      ...
      <section className="bg-[var(--black)] text-white py-20">
        <div className="mx-auto max-w-6xl px-6 grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* 4 - ✅ FIX: Fixed broken className text-[#ffff" → text-white/90 */}
            <div className="rounded-2xl border border-white/10 p-5 bg-white/[0.03]">
              <div className="text-white/90">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path
      ...
      <section className="mx-auto max-w-6xl px-6 py-14">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="p-7">
            ...
            {/* ✅ FIX: iOS links to WhatsApp, Google Play tracks conversion */}
            <div className="mt-5 flex flex-col sm:flex-row gap-3">
              ...
              {/* Google Play - ✅ Tracks conversion on click */}
              <a
                href={PLAY_STORE_URL}
      ...
      {/* ✅ FIX: Store modal - iOS goes to WhatsApp, Google Play tracks conversion */}
      {isStoreModalOpen && (
